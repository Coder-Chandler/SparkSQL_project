...
object sfz200_400 {
  def main(args: Array[String]): Unit = {
    ...
    //把json文件加载成DataFrame
    val peopledataframe = spark.read.format("csv").load("/Users/chandler/Documents/Data/NumPhone/2000W/200W-400W.csv")
    ...
    ).filter("_c19 != '' and _c5='F' and _c6>19850101")

    clean_sfz.show(false)
    println(clean_sfz.count())

//    clean_sfz.show()
//
//    clean_sfz.coalesce(1).write.format("csv").mode(SaveMode.Overwrite)
//      .save("/Users/chandler/Documents/Data/NumPhone/clean_sfz/200-400")
