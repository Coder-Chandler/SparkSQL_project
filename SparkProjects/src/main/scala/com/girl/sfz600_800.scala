...
object sfz600_800 {
  def main(args: Array[String]): Unit = {
    ...
    //把json文件加载成DataFrame
    val peopledataframe = spark.read.format("csv").load("/Users/chandler/Documents/Data/NumPhone/2000W/600W-800W.csv")
    ...
    clean_sfz.coalesce(1).write.format("csv").mode(SaveMode.Overwrite)
      .save("/Users/chandler/Documents/Data/NumPhone/clean_sfz/600-800")
