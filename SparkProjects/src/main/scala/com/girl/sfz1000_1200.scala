...
object sfz1000_1200 {
  def main(args: Array[String]): Unit = {
    ...
    //把json文件加载成DataFrame
    val peopledataframe = spark.read.format("csv").load("/Users/chandler/Documents/Data/NumPhone/2000W/1000W-1200W.csv")
    ...
    clean_sfz.coalesce(1).write.format("csv").mode(SaveMode.Overwrite)
      .save("/Users/chandler/Documents/Data/NumPhone/clean_sfz/1000-1200")
