...
object nanjing1200_1400 {
  def main(args: Array[String]): Unit = {
    ...
    //把json文件加载成DataFrame
    val peopledataframe = spark.read.format("csv").load("/Users/chandler/Documents/Data/NumPhone/clean_sfz/1200-1400/1200-1400.csv")
    ...
    nanjing.coalesce(1).write.format("csv").mode(SaveMode.Overwrite)
      .save("/Users/chandler/Documents/Data/NumPhone/chuchu/chuchu/1200-1400")
