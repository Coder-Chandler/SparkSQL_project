...
object nanjing400_600 {
  def main(args: Array[String]): Unit = {
    ...
    //把json文件加载成DataFrame
    val peopledataframe = spark.read.format("csv").load("/Users/chandler/Documents/Data/NumPhone/clean_sfz/400-600/400-600.csv")
    ...
    nanjing.coalesce(1).write.format("csv").mode(SaveMode.Overwrite)
      .save("/Users/chandler/Documents/Data/NumPhone/chuchu/chuchu/400-600")
